...
| `/fix` | The homepage served from a colour-corrected copy of the artwork photographs, for live comparison against `/`. Generated by `scripts/build-fix-page.mjs` — re-run it whenever `public/index.html` changes. |
